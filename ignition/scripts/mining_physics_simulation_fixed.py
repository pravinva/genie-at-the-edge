...
# Logging
# Logger disabled for gateway timer script
...
def simulate_haul_truck(truck_id, truck_index):
    ...
    try:
        ...
        print("ERROR: " + "Error simulating {}: {}".format(truck_id, str(e)))
...
def simulate_crusher(crusher_id):
    ...
    try:
        ...
        print("ERROR: " + "Error simulating {}: {}".format(crusher_id, str(e)))
...
def simulate_conveyor(conveyor_id):
    ...
    try:
        ...
        print("ERROR: " + "Error simulating {}: {}".format(conveyor_id, str(e)))
...
def execute_simulation():
    ...
    try:
        ...
        if execution_count % 60 == 0:
            print("INFO: " + "Physics simulation running - {} executions completed".format(execution_count))
            ...
            print("INFO: " + "Sample: HT_001 speed = {:.1f} km/h".format(sample_value))

    except Exception as e:
        print("ERROR: " + "Physics simulation error: {}".format(str(e)))
